...
$get_invoices = mysql_query("SELECT invoice_id, date_created, purpose, purchase_order, tax1_percent, tax2_percent, tax1_total, tax2_total, total, received, due FROM invoices WHERE client_id = '$client_id'");
