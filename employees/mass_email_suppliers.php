...
while($show_supplier = mysql_fetch_array($get_suppliers)) {
...
$mail->AddAddress($show_supplier['email_address']);
...
<title><?php echo $show_company['company_name'] ?> - Mass E-mail Suppliers</title>
...
<div id="smallwrap">
  <div id="header">
    <h1><img src="../images/icons/email.png" alt="Mass E-mail Suppliers" width="16" height="16" /> Mass E-mail Suppliers:</h1>
    <p>You can sent a composed e-mail to all suppliers by using this form.</p>
  </div>
  <div id="content">
