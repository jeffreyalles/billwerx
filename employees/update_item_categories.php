...
$total_records = mysql_num_rows($get_item_categories);
...
$doSQL = "INSERT INTO item_categories (name) VALUES ('$name')";
...
<title><?php echo $show_company['company_name'] ?> - Update Item Categories</title>
...
<div id="smallwrap">
  <div id="header">
    <h1><img src="../images/icons/items.png" alt="Update Item Category" width="16" height="16" /> Update Item Categories:</h1>
