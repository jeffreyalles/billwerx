...
<div id="wrap">
  <div id="header">
    <h1><?php echo $show_supplier['first_name'] ?> <?php echo $show_supplier['last_name'] ?></h1>
    <h3>Record created <?php echo $show_supplier['created'] ?> by: <a href="mailto:<?php echo $show_employee['email_address'] ?>?subject=Client: <?php echo strtoupper($show_client['last_name']) ?>, <?php echo $show_client['first_name'] ?>"><?php echo strtoupper($show_employee['last_name']) ?>, <?php echo $show_employee['first_name'] ?></a>.</h3>
  </div>
  <div id="logininfo">
          ...
          <td class="halftopcell"><h2>Contact: </h2>
            <table class="fulltable">
              <tr>
                ...
                <td colspan="2"><input name="first_name" type="text" class="entrytext" id="first_name" value="<?php echo $show_supplier['first_name'] ?>" /></td>
              </tr>
              <tr>
                <td class="firstcell">last name:</td>
                <td colspan="2"><input name="last_name" type="text" class="entrytext" id="last_name" value="<?php echo $show_supplier['last_name'] ?>" /></td>
              </tr>
              <tr>
                <td class="firstcell">company name:</td>
                <td colspan="2"><input name="company_name" type="text" class="entrytext" id="company_name" value="<?php echo $show_supplier['company_name'] ?>" /></td>
              </tr>
              <tr>
                <td class="firstcell">home number:</td>
                <td colspan="2"><input name="home_number" type="text" class="entrytext" id="home_number" onblur="cleanNumber(this);formatNumber(this)" value="<?php echo $show_supplier['home_number'] ?>" /></td>
              </tr>
              <tr>
                <td class="firstcell">work number:</td>
                <td colspan="2"><input name="work_number" type="text" class="entrytext" id="work_number" onblur="cleanNumber(this);formatNumber(this)" value="<?php echo $show_supplier['work_number'] ?>" /></td>
              </tr>
              <tr>
                <td class="firstcell">mobile number:</td>
                <td colspan="2"><input name="mobile_number" type="text" class="entrytext" id="mobile_number" onblur="cleanNumber(this);formatNumber(this)" value="<?php echo $show_supplier['mobile_number'] ?>" /></td>
              </tr>
              <tr>
                <td class="firstcell">fax number:</td>
                <td colspan="2"><input name="fax_number" type="text" class="entrytext" id="fax_number" onblur="cleanNumber(this);formatNumber(this)" value="<?php echo $show_supplier['fax_number'] ?>" /></td>
              </tr>
              <tr>
                ...
                <td><input name="email_address" type="text" class="entrytext" id="email_address" value="<?php echo $show_supplier['email_address'] ?>" />
                  <a href="mailto:<?php echo $show_supplier['email_address'] ?>"></a></td>
                <td class="lastcell"><a href="mailto:<?php echo $show_supplier['email_address'] ?>"><img src="../images/icons/email.png" alt="E-mail" width="16" height="16" class="iconspacer" /></a></td>
              </tr>
          </table>
            ...
            <table class="fulltable">
              <tr>
                ...
                <td><input name="website" type="text" class="entrytext" id="website" value="<?php echo $show_supplier['website'] ?>" /></td>
                <td class="lastcell"><a href="http://<?php echo $show_supplier['website'] ?>"><img src="../images/icons/internet.png" alt="Website" width="16" height="16" class="iconspacer" /></a></td>
              </tr>
            </table></td>
