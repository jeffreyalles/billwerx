...
$get_suppliers = mysql_query("SELECT * FROM suppliers ORDER BY supplier_id DESC LIMIT $start, " . $_SESSION['records_per_page'] . "");
  ...
  <div id="content">
    <form id="suppliers" name="suppliers" method="get" action="<?php echo $_SERVER['PHP_SELF'] ?>">
      <table class="fulltable">
        <tr>
          <td class="halftopcell"><h1><img src="../images/icons/suppliers.png" alt="Suppliers" width="16" height="16" /> Suppliers:</h1>
          <table class="fulltable">
              <tr>
              ...
              <tr>
                <td><input name="create" type="button" class="button" id="create" onclick="window.location='create_supplier.php'" value="CREATE" />
                  <input name="export" type="button" class="button" id="export" onclick="window.location='export_suppliers.php'" value="EXPORT" /></td>
              </tr>
          </table></td>
      ...
      <table class="fulltable">
        <tr>
          ...
          <td class="tabletop">full name / e-mail:</td>
