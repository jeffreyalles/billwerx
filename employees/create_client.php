...
$doSQL = "INSERT INTO clients (first_name, last_name, company_name, home_number, work_number, mobile_number, fax_number, email_address, payment_terms, discount, billing_email_address, account_password, campaign_id, billing_address, billing_city, billing_province, billing_postal, billing_country, shipping_address, shipping_city, shipping_province, shipping_postal, shipping_country, employee_id) VALUES ('$first_name', '$last_name', '$company_name', '$home_number', '$work_number', '$mobile_number', '$fax_number', '$email_address', '$payment_terms', '$discount', '$billing_email_address', '$account_password', '$campaign_id', '$billing_address', '$billing_city', '$billing_province', '$billing_postal', '$billing_country', '$shipping_address', '$shipping_city', '$shipping_province', '$shipping_postal', '$shipping_country', '$employee_id')";
...
<div id="wrap">
  <div id="header">
    <h1><img src="../images/icons/clients.png" alt="Create Client" width="16" height="16" /> Create Client:</h1>
    <p>Welcome</p>
    <div id="navbar">
