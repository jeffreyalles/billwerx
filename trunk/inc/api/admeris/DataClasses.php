...
class CreditCard {
	...
	$street = null, $zip = null, $secureCode = null, $magneticData = null) {
...
class CreditCardReceipt {
	...
	function CreditCardReceipt($response = null) {
		...
		$this->approved = $this->params["APPROVED"];
		...
		if ($avsResponseAvailable != null && $avsResponseAvailable) {
			...
			$this->params["AVS_ERROR_CODE"],
			$this->params["AVS_ERROR_MESSAGE"]);
		} else {
		...
		if ($periodicPurchaseId != null) {
			//$periodicPurchaseState = $periodicPurchaseInfo->state.this.parseShort("PERIODIC_TRANSACTION_STATE"));
			$periodicPurchaseState = $this->params["PERIODIC_TRANSACTION_STATE"];
			$this->periodicPurchaseInfo = new PeriodicPurchaseInfo($periodicPurchaseId, $periodicPurchaseState);
		} else {
...
class VerificationRequest {
	...
	// constructor
	function VerificationRequest($avsRequest, $cvv2Request) {
...
class PeriodicPurchaseInfo
{
	...
	function PeriodicPurchaseInfo($periodicTransactionId, $state) {
