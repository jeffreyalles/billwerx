...
<div id="wrap">
  <div id="header">
    <h1><?php echo $show_employee['first_name'] ?> <?php echo $show_employee['last_name'] ?></h1>
    <h3>Record created <?php echo $show_employee['created'] ?>.</h3>
  </div>
  <div id="logininfo">
          ...
          <td class="halftopcell"><h2>Contact:</h2>
            <table class="fulltable">
              <tr>
                ...
                <td colspan="2"><input name="first_name" type="text" class="entrytext" id="first_name" value="<?php echo $show_employee['first_name'] ?>" /></td>
              </tr>
              <tr>
                <td class="firstcell">last name:</td>
                <td colspan="2"><input name="last_name" type="text" class="entrytext" id="last_name" value="<?php echo $show_employee['last_name'] ?>" /></td>
              </tr>
              <tr>
                <td class="firstcell">home number:</td>
                <td colspan="2"><input name="home_number" type="text" class="entrytext" id="home_number" onblur="cleanNumber(this);formatNumber(this)" value="<?php echo $show_employee['home_number'] ?>" /></td>
              </tr>
              <tr>
                <td class="firstcell">work number:</td>
                <td colspan="2"><input name="work_number" type="text" class="entrytext" id="work_number" onblur="cleanNumber(this);formatNumber(this)" value="<?php echo $show_employee['work_number'] ?>" /></td>
              </tr>
              <tr>
                <td class="firstcell">mobile number:</td>
                <td colspan="2"><input name="mobile_number" type="text" class="entrytext" id="mobile_number" onblur="cleanNumber(this);formatNumber(this)" value="<?php echo $show_employee['mobile_number'] ?>" /></td>
              </tr>
              <tr>
                <td class="firstcell">pager number:</td>
                <td colspan="2"><input name="pager_number" type="text" class="entrytext" id="pager_number" onblur="cleanNumber(this);formatNumber(this)" value="<?php echo $show_employee['pager_number'] ?>" /></td>
              </tr>
              <tr>
                <td class="firstcell">fax number:</td>
                <td colspan="2"><input name="fax_number" type="text" class="entrytext" id="fax_number" onblur="cleanNumber(this);formatNumber(this)" value="<?php echo $show_employee['fax_number'] ?>" /></td>
              </tr>
              <tr>
                ...
                <td><input name="email_address" type="text" class="entrytext" id="email_address" value="<?php echo $show_employee['email_address'] ?>" />
                  <a href="mailto:<?php echo $show_employee['email_address'] ?>"></a></td>
                <td class="lastcell"><a href="mailto:<?php echo $show_employee['email_address'] ?>"><img src="../images/icons/email.png" alt="E-mail" width="16" height="16" class="iconspacer" /></a></td>
              </tr>
              <tr>
                <td class="firstcell">account password:<br />
                  <a href="javascript:randomString();">generate random string</a></td>
                <td colspan="2"><input name="account_password" type="password" class="entrytext" id="account_password" value="<?php echo $show_employee['account_password'] ?>" /></td>
              </tr>
            </table>
            <h2>Financials: </h2>
            <table class="fulltable">
          ...
          <td class="halftopcell"><h2>Specifics:</h2>
            ...
            <table class="fulltable">
              <tr>
                ...
                <td><input name="records_per_page" type="text" class="entrytext" id="records_per_page" value="<?php echo $show_employee['records_per_page'] ?>" /></td>
              </tr>
            </table>
            <p>&nbsp;</p></td>
        </tr>
