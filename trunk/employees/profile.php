          ...
          <td class="halftopcell"><h2>Contact:</h2>
            <table class="fulltable">
              ...
              <tr>
                ...
                <td colspan="2"><input name="home_number" type="text" class="entrytext" id="home_number" onblur="formatNumber(this)" value="<?php echo $show_employee['home_number'] ?>" /></td>
              </tr>
              <tr>
                <td class="firstcell">work number:</td>
                <td colspan="2"><input name="work_number" type="text" class="entrytext" id="work_number" onblur="formatNumber(this)" value="<?php echo $show_employee['work_number'] ?>" /></td>
              </tr>
              <tr>
                <td class="firstcell">mobile number:</td>
                <td colspan="2"><input name="mobile_number" type="text" class="entrytext" id="mobile_number" onblur="formatNumber(this)" value="<?php echo $show_employee['mobile_number'] ?>" /></td>
              </tr>
              <tr>
                <td class="firstcell">pager number:</td>
                <td colspan="2"><input name="pager_number" type="text" class="entrytext" id="pager_number" onblur="formatNumber(this)" value="<?php echo $show_employee['pager_number'] ?>" /></td>
              </tr>
              <tr>
                <td class="firstcell">fax number:</td>
                <td colspan="2"><input name="fax_number" type="text" class="entrytext" id="fax_number" onblur="formatNumber(this)" value="<?php echo $show_employee['fax_number'] ?>" /></td>
              </tr>
              <tr>
                <td class="firstcell">e-mail address:</td>
                <td><input name="email_address" type="text" class="entrytext" id="email_address" value="<?php echo $show_employee['email_address'] ?>" /></td>
              ...
              <tr>
                ...
                <td colspan="2"><input name="account_password" type="text" class="entrytext" id="account_password" value="<?php echo $show_employee['account_password'] ?>" /></td>
              </tr>
            </table></td>
